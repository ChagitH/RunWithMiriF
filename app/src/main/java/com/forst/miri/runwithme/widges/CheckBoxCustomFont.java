...
public class CheckBoxCustomFont extends android.support.v7.widget.AppCompatCheckBox {
    public CheckBoxCustomFont(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CheckBoxCustomFont, 0, 0);
        String fontStyle = a.getString(R.styleable.CheckBoxCustomFont_customFontStyleCheckBox);
        a.recycle();
